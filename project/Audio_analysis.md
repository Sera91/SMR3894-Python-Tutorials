...
$$\large
 \left [ \begin{bmatrix}{y(0) & y(1) \\ y(1) & y(2) \\ y(2) & y(3)\\ \vdots & \vdots }\end{bmatrix}  \right ] \cdot \left [ \matrix{h_W(1) \\ h_W(0) }  \right ] =\left[\begin{matrix}{ x(0) \\  x(1) \\ x(2) \\ \vdots  }\end{bmatrix} \right] $$
